...
{{-- <div class="ml-52">
    <div class="relative bg-stone-900 text-white p-2">
        ...
        <div
            class="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 p-1 rounded-full flex items-center justify-center duration-200 hover:opacity-80 hover:scale-105">
