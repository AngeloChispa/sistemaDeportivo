        ...
        <div class="flex justify-stretch">
            ...
            <div class="mr-5 w-72 text-sm text-center rtl:text-right text-zinc-300">
                <div class="flex-col">
                    ...
                    {{-- cl 1--}}
                    <div class=" text-lg font-semibold text-left rtl:text-right text-zinc-300 bg-stone-900 rounded-lg mb-5 break-words">
            ...
            <div class="mr-5 w-1/2 text-base text-left rtl:text-right text-zinc-300">
                <div class="flex-col">
                    ...
                    <div class="mb-5">                   
                        ...
                        <div class="p-3 text-base font-semibold text-center text-zinc-300 bg-stone-900 flex justify-start items-start  rounded-b-lg">
                            
                            <div class="bg-stone-800 rounded-full p-1.5 hover:bg-[#333333] mr-2"> <!-- Margen a la derecha -->
                    ...
                    <div class="mb-5 rounded-lg bg-stone-900"> <!-- Contenedor principal -->
                        ...
                        <div class="p-5 text-base font-semibold text-center text-zinc-300 bg-stone-900 flex justify-between items-center hover:bg-[#333333]">
                        ...
                        <div class="p-5 text-base font-semibold text-center text-zinc-300 bg-stone-900 flex justify-between items-center hover:bg-[#333333]  rounded-b-lg">
                            <span class="flex-1 text-right flex items-center justify-end">
                                Villareal
                    ...
                    <div class="p-5 text-base font-semibold text-center text-zinc-300 bg-stone-900 flex justify-between items-center rounded-b-lg hover:bg-[#333333]">
                        <span class="flex-1 text-right flex items-center justify-end">
                            Liverpool
                            <img src="{{ asset('assets/img/liverpool.png') }}" class="h-6 w-6 ml-2" alt="Real Madrid">
                        </span>
                ...
                <div class="text-lg font-semibold text-left rtl:text-right text-zinc-300 bg-stone-900 rounded-lg mb-5 break-words">
                    <div class="flex flex-col pl-5 bg-stone-800 p-1 rounded-t-lg font-semibold">
                        <div class="flex items-center mb-1">
                            ...
                            <div class="ml-[105px] flex items-center justify-center w-16 h-16 rounded-full border border-stone-600">
